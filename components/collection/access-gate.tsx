        ...
        {reason === 'login' ? (
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              ...
              className="bg-brand-gold text-brand-bg hover:bg-brand-gold-light rounded-xl w-full sm:w-auto"
            >
              Sign In
            </Button>
            <Button
              ...
              className="border-brand-gold/20 text-brand-cream rounded-xl w-full sm:w-auto"
            >
