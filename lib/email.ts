    ...
    html: `
      <div style="font-family: 'Georgia', serif; max-width: 600px; margin: 0 auto; color: #1C1917;">
        <div style="background-color: #0F0D0B; padding: 32px; border-radius: 16px;">
          <h1 style="color: #C8956C; font-size: 24px; margin: 0 0 8px;">You&rsquo;re Now a Premium Member</h1>
          <p style="color: #F5F0E8; font-size: 16px; margin: 0 0 24px;">Full access to the Reparation Road archive is yours.</p>

          <p style="color: #A8A29E; font-size: 14px; line-height: 1.6;">
            Hi ${name},
          </p>
          <p style="color: #A8A29E; font-size: 14px; line-height: 1.6;">
            Thank you for subscribing to the <strong style="color: #F5F0E8;">${planName}</strong> plan. Your support helps us preserve and digitize historical records for future generations.
          </p>

          <p style="color: #F5F0E8; font-size: 14px; font-weight: bold; margin: 24px 0 12px;">
          ...
          <p style="color: #A8A29E; font-size: 14px; line-height: 1.6; margin-top: 24px;">
            Start exploring: <a href="https://reparationroad.org/collection" style="color: #C8956C; text-decoration: underline;">Browse all collections</a>
          </p>

          <p style="color: #A8A29E; font-size: 14px; line-height: 1.6;">
            You can manage your subscription anytime from your <a href="https://reparationroad.org/dashboard/settings" style="color: #C8956C; text-decoration: underline;">account settings</a>.
          </p>
