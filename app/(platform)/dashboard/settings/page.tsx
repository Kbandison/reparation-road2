...
export default function SettingsPage() {
  ...
  useEffect(() => {
    // Seeds the form once the profile arrives from context, which happens after
    // first render — a useState initialiser would capture null and never update.
    if (profile) {
  ...
  return (
    <>
      ...
      <div className="max-w-xl space-y-8">
        ...
        {/* Community profile now lives on the dashboard, where it is the first
            thing you see. Two editors for the same six fields meant whichever
            you found second looked like it had stale data. */}
        <div className="bg-brand-card border border-brand-gold/[0.08] rounded-2xl p-6">
          ...
          <p className="text-sm text-brand-muted mt-1">
            Your photo, handle, bio and research interests are edited on your{' '}
